...
from app.routers.sucursal import ciudad_router, tipo_sucursal_router, sucursal_router, tarifario_router, tipo_vehiculo_router, vehiculo_router, segmento_router, tipo_salida_router, salida_router
