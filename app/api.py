...
from app.routers.test import test_tarifario_router, test_sucursal_router, test_usuario_router, test_segmento_router, test_salida_router, test_gasto_router,test_ciudad_router,test_ingreso_router,test_vehiculo_router, test_dashboard_router
...
api_router.include_router(test_vehiculo_router.router)
api_router.include_router(test_ciudad_router.router)
api_router.include_router(test_ingreso_router.router)
api_router.include_router(test_dashboard_router.router)
